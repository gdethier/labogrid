...
public class D3Q19SRTSmagoBlockCollider extends D3Q19SRTBlockCollider {
	...
	public void setParameters(String[] params) throws LBException {
		...
		if(params.length != 6)
			throw new LBException("Usage: <omega> <xAcc> <yAcc> <zAcc> <csmago> <blockSize>");
		...
		int blockSize = Integer.parseInt(params[5]);

		setParameters(omega, csmago, xAccel, yAccel, zAccel, blockSize);
	}
	
	public void setParameters(double omega, double csmago, double xAccel, double yAccel, double zAccel, int blockSize) {
		super.setParameters(omega, xAccel, yAccel, zAccel, blockSize);
