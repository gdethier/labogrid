...
public class CentralInputGetNextChunkMessage extends CentralInputServerMessage
		implements GetNextChunkRequest, StandAloneIoServerMessage {

	private static final long serialVersionUID = 1L;
	
	public CentralInputGetNextChunkMessage() {
	}
