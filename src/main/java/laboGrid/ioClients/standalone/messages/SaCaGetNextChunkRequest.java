...
public class SaCaGetNextChunkRequest extends MasterMessage implements
		GetNextChunkRequest, StandAloneIoServerMessage, OutputClientMessage {
	private String fileUID;

	public SaCaGetNextChunkRequest(String fileUID) {
