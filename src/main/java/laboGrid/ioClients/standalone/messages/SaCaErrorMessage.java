...
public class SaCaErrorMessage extends MasterMessage implements
		ErrorMessage, StandAloneIoServerMessage, InputClientMessage {
	private String msg;
	private String fileUID;

	public SaCaErrorMessage(String msg, String fileUID) {
		this.msg = msg;
