...
public class IterationLogger extends LBLogger {
	
	public IterationLogger() {
		
	}

	protected IterationLogger(IterationLogger other) {
	...
	protected Log getLog(int iteration) {
		...
		return new IterationLog(this, iteration);

	}

	@Override
	public ProcessingChainElement clone() {
		return new IterationLogger(this);
	}
