...
public class CentralInputErrorMessage extends LBSimulationMessage implements
		ErrorMessage, InputClientMessage {
	...
	public CentralInputErrorMessage(String msg, String fileUID) {
		this.msg = msg;
