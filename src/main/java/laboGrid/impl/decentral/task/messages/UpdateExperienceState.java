...
public class UpdateExperienceState extends WorkerMessage {
	private ExperienceState expState;
	private boolean forced;

	public UpdateExperienceState(ExperienceState expState, boolean forced) {
		this.expState = expState;
		this.forced = forced;
	}

	public UpdateExperienceState(DAId t, ExperienceState expState, boolean forced) {
		super(t);
		this.expState = expState;
		this.forced = forced;
	}
